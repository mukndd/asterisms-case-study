...
This folder is a standalone, recruiter-safe showcase package for the private Asterisms project. It contains public-facing HTML, CSS, screenshots captured from the current product, a high-level architecture diagram, and PDF-ready recruiter materials.
...
- Live site health check: 200 OK at the public health endpoint.
- Data validation: passed with 88 constellations, 74 asterisms, 9,036 unique stars, zero warnings, zero hard failures.
- Tests: 14 test files passed, 79 tests passed.
- TypeScript: passed.
- Lint: passed.
- Production build: passed.
- Generated app pages: 186 static pages plus dynamic routes.
